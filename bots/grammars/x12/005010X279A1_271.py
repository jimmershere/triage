# bots/grammars/x12/005010X279A1_271.py
...
recorddefs = {
    ...
    'EB' :[(['ID',1,2],'Elig'),(['ID',1,2],'CovLevel'),(['ID',1,3],'ServiceType'),(['ID',1,2],'PlanCov'),(['ID',2,2],'InsType'),(['ID',2,3],'Netwk'),(['AN',1,99],'Desc')],
    'HSD':[(['ID',1,3],'MeasCode'),(['N0',1,9],'Qty')],
